module DropboxApiV2::Endpoints::Files
  class ListFolderLongpoll < DropboxApiV2::Endpoints::RpcNotify
    Method      = :post
    Path        = "/2/files/list_folder/longpoll".freeze
    ResultType  = DropboxApiV2::Results::ListFolderLongpollResult
    ErrorType   = DropboxApiV2::Errors::ListFolderLongpollError
